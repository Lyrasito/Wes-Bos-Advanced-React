...
function (_React$Component) {
  ...
  function RemoveFromCart() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      var cartItem = data.me.cart.filter(function (item) {
        return item.id === cartItemId;
      });
      var cartItemIndex = data.me.cart.indexOf(function (item) {
        return item.id === cartItem[0].id;
      });
      console.log(cartItemIndex);

      if (cartItem[0].quantity > 1) {
        console.log("quantity >1");
        data.me.cart[cartItemIndex].quantity = cartItem[0].quantity - 1;
        console.log(data.me.cart[cartItemIndex]);
...
//# sourceMappingURL=_app.js.6a8fa9a95e933fefa5aa.hot-update.js.map