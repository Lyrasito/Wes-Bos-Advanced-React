...
})(["position:relative;.count{display:block;position:relative;transition:all 4s;backface-visibility:hidden;}.count-enter{transform:rotateX(0.5turn);}.count-enter-active{transform:rotateX(0turn);}.count-exit{top:0;position:absolute;transform:rotateX(0turn);}.count-exit-active{transform:rotateX(0.5turn);}"]);
...
//# sourceMappingURL=_app.js.4b73217edfe074a21d3a.hot-update.js.map