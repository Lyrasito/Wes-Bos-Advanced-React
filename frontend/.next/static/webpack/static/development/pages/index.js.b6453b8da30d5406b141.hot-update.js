...
function (_React$Component) {
  ...
  function DeleteItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      console.log("payload", payload); //2. filter the deleted item out of the page

      data.items = data.items.filter(function (item) {
        return item.id !== payload.data.deleteItem.id;
      });
      console.log("data after filter", data); //3. put the items back
...
//# sourceMappingURL=index.js.b6453b8da30d5406b141.hot-update.js.map